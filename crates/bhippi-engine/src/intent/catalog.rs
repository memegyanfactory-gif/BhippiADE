...
const PRESETS: &[PresetCard] = &[
    ...
    // ---------------------------------------------------------------- hud
    // Mirrors `godot::hud::presets()`, which is what actually builds these. The
    // `the_catalogue_and_the_builder_agree` test fails the build if the two drift.
    PresetCard {
    ...
    PresetCard {
        ...
        title: "Lap and timer",
        purpose: "Position and lap top-left, the split clock top-right, speed as a dial bottom-\n                  right.",
        godot_nodes: &[
            "CanvasLayer",
            "Control",
            "HBoxContainer",
    ...
    PresetCard {
        ...
        purpose: "The objective top-left, a collected-of-target readout top-right and a compass\n                  strip across the top.",
        godot_nodes: &[
            "CanvasLayer",
            "Control",
            "HBoxContainer",
    ...
    PresetCard {
        ...
        purpose: "A reticle in the centre, health bottom-left, ammo bottom-right and the frag\n                  tally top-right.",
        godot_nodes: &[
            "CanvasLayer",
            "ColorRect",
            "Control",
    ...
    PresetCard {
        ...
        purpose: "Distance across the top centre, the multiplier and the best run top-right.",
        godot_nodes: &[
            "CanvasLayer",
            "Control",
            "HBoxContainer",
        ...
        properties: &[
            ...
            text("distance_unit", "m"),
        ],
    },
    PresetCard {
        id: "preset.hud.survival_meters",
        title: "Survival meters",
        purpose: "Health, hunger and stamina stacked top-left, the clock top-right, a compass\n                  across the top. Exactly at the persistent budget.",
        godot_nodes: &[
            "CanvasLayer",
            "ColorRect",
            "Control",
    ...
    PresetCard {
        ...
        title: "Boss fight",
        purpose: "A named boss meter across the top centre with phase pips, the player's own\n                  health bottom-left.",
        godot_nodes: &[
            "CanvasLayer",
            "ColorRect",
            "Control",
    ...
    PresetCard {
        ...
        purpose: "A combo counter and an accuracy meter top-right, the beat line across the top\n                  centre.",
        godot_nodes: &[
            "CanvasLayer",
            "ColorRect",
            "Control",
    ...
    PresetCard {
        ...
        purpose: "A north-up minimap top-right with a fixed legend, the objective top-left.",
        godot_nodes: &[
            "CanvasLayer",
            "Control",
            "HBoxContainer",
    ...
    PresetCard {
        ...
        title: "Minimal",
        purpose: "One persistent line and a toast channel. The HUD for a game whose subject is\n                  the world, not the numbers.",
        godot_nodes: &[
            "CanvasLayer",
            "Control",
            "HBoxContainer",
        ...
        properties: &[boolean("show_objective", "true"), number("toast_seconds", "3")],
    },
    PresetCard {
        id: "preset.hud.scifi_mecha",
        title: "Sci-Fi and Mecha",
        purpose: "High-tech armor and shield bars top-left, core heat ring bottom-right, pilot level badge, and system notices.",
        godot_nodes: &[
            "CanvasLayer",
            "ColorRect",
            "Control",
    ...
    PresetCard {
        ...
        title: "Hero and MOBA",
        purpose: "Hero portrait and health/mana bars bottom-left, ability cooldown row bottom-right, and match timer top-centre.",
        godot_nodes: &[
            "CanvasLayer",
            "ColorRect",
            "Control",
    ...
    PresetCard {
        ...
        title: "Pixel RPG",
        purpose: "Pixel heart containers top-left, stamina meter below, gold and key counters top-right, and active equipment row bottom-left.",
        godot_nodes: &[
            "CanvasLayer",
            "ColorRect",
            "Control",
    ...
    PresetCard {
        ...
        purpose: "Fuel gauge and gear indicator bottom-left, tachometer dial bottom-right, and objective task top-left.",
        godot_nodes: &[
            "CanvasLayer",
            "ColorRect",
            "Control",
    ...
    PresetCard {
        ...
        purpose: "Player health bar and super meter top-left, opponent health top-right, and hit combo counter mid-right.",
        godot_nodes: &[
            "CanvasLayer",
            "ColorRect",
            "Control",
    ...
    PresetCard {
        ...
        title: "Retro arcade",
        purpose: "1UP and HIGH score counters top-left, credits and bomb pips top-right, and life pips bottom-left.",
        godot_nodes: &[
            "CanvasLayer",
            "Control",
            "HBoxContainer",
