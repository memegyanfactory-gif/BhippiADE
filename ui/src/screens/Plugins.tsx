// The Plugins gallery (docs/04-PAGES.md, ADR-0028). Everything this screen shows about
...
export function Plugins({ onOpenTarget }: { onOpenTarget: (target: string) => void }) {
        ...
        <header className="plugins-head">
          <div>
            ...
            <p className="screen-sub">
              Browse, install, enable and manage tools for your workspace.
            </p>
          </div>
